                            ...
                            <div className="flex gap-2">
                                <div>
                                    <span className="text-sm">
                                        <a href="https://example.com" target="_blank" rel="noreferrer" className="underline">Demo</a>
                                    </span>
                                </div>
                                <div>
                                    <span className="text-sm">
                                        <a href="https://example.com" target="_blank" rel="noreferrer" className="underline">Repo</a>
                                    </span>
                                </div>
                            </div>
                        </div>
